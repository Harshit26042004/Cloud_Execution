...
extension_key = {'.blend': ('3D Modeling File',
...
mime_key = {'application/x-blender': ('3D Modeling File', 'Blender 3D File'), 
...
class Classifier:
    ...
    def classify(self, path):
        ...
        if file_ext in extension_key:
            file_type.add(extension_key[file_ext])
